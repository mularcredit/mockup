                ...
                <div className="space-y-3 pt-4 border-t border-gray-200">
                  ...
                  {(transcript || summary) && (
                    <button
                      ...
                      className="w-full py-2 px-3 border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-[var(--glass-h)] flex items-center justify-center transition-colors"
                    >
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
