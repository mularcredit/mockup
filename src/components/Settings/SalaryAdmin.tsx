      ...
      <div className="bg-[var(--card)] rounded-[10px] max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-md px-2.5 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500"
                />
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-2">
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="px-4 py-2 text-xs font-medium text-white bg-gray-900 rounded-[25px] border border-gray-700 hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
          >
            {isLoading ? (
              <>
      ...
      <div className="bg-[var(--card)] rounded-[10px] max-w-md w-full p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-[10px] p-4 text-center">
              <input
                type="file"
                accept=".csv,.xlsx,.xls"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-md px-2.5 py-1.5 text-xs focus:ring-1 focus:ring-green-500 focus:border-green-500"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-2">
      ...
      <div className="bg-[var(--card)] rounded-[10px] max-w-md w-full p-6">
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={4}
            className="w-full border border-gray-200 rounded-md px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
          />
        </div>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium text-white bg-blue-600 rounded-md border border-blue-700 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Submit Comment
          </button>
        </div>
        ...
        {isChecker && request.status === 'pending' && (
          <>
            <button
              ...
              className="flex-1 px-3 py-1.5 text-xs font-medium text-white bg-green-600 rounded-[25px] border border-green-700 hover:bg-green-700 flex items-center justify-center gap-2 transition-colors"
            >
            ...
            <button
              ...
              className="flex-1 px-3 py-1.5 text-xs font-medium text-white bg-red-600 rounded-[25px] border border-red-700 hover:bg-red-700 flex items-center justify-center gap-2 transition-colors"
            >
      ...
      <div className="bg-[var(--card)] rounded-[10px] max-w-md w-full p-6">
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={4}
            className="w-full border border-gray-200 rounded-md px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500"
          />
        </div>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="px-4 py-2 text-xs font-medium text-white bg-red-600 rounded-[25px] border border-red-700 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Confirm Rejection
          </button>
        </div>
      ...
      <div className="bg-[var(--card)] rounded-[10px] max-w-md w-full p-6">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="px-4 py-2 text-xs font-medium text-white bg-blue-600 rounded-[25px] border border-blue-700 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
        ...
        <div className="bg-[var(--card)] rounded-[10px] max-w-md w-full p-6">
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button
              onClick={handleExport}
              disabled={isLoading}
              className="px-3 py-1.5 text-xs font-medium text-white bg-green-600 rounded-md border border-green-700 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isLoading ? (
                <>
                  <div className="animate-spin rounded-full h-4 w-4 border-t-2 border-b-2 border-white"></div>
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          {callback.transaction_id && (
                            <button
                              ...
                              className="text-xs text-green-600 hover:text-green-900 font-medium text-left flex items-center gap-1"
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between mt-6 px-4 py-3 border-t border-gray-200">
              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <div>
                  <nav className="inline-flex -space-x-px rounded-[10px] shadow-sm" aria-label="Pagination">
                    <button
                      onClick={() => paginate(currentPage - 1)}
                      disabled={currentPage === 1}
            ...
            <div className="p-6">
              ...
              <div className="flex justify-end pt-4 border-t border-gray-200">
                <button
                  ...
                  disabled={isCheckingStatus}
                  className="mr-3 px-3 py-1.5 text-xs font-medium text-white bg-blue-600 rounded-md border border-blue-700 hover:bg-blue-700 disabled:opacity-50"
                >
    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-[var(--card)] border border-[var(--p-line)] rounded-xl max-w-4xl w-full p-6 max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="mb-4 p-3 bg-[var(--p-dim)] border border-[var(--p-line)] rounded-xl">
          ...
          <div className="mt-3 p-2 bg-amber-50 border border-amber-200 rounded-[10px]">
                ...
                <li key={app.id} className={`py-2 flex items-center justify-between ${!isFromCurrentMonth ? 'opacity-50 pointer-events-none' : ''}`}>
                  <div className="flex items-center">
                    <button
                      ...
                      className="text-xs mr-2 text-green-600 hover:text-green-800"
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            onClick={onProcess}
            className="px-4 py-2 text-xs font-medium text-white bg-green-600 rounded-[25px] border border-green-700 hover:bg-green-700 flex items-center gap-2 transition-colors"
        ...
        {activeTab === 'settings' ? (
          ...
          <div className="space-y-4">
              ...
              <div className="bg-[var(--p-dim)] border border-[var(--p-line)] rounded-xl p-6">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                    ...
                    {isLoadingRequests && <Loader className="w-4 h-4 animate-spin text-gray-400" />}
                  </h2>
                  <button onClick={() => setShowApprovalQueue(false)} className="text-xs text-gray-400 hover:text-gray-600">
                  ...
                  <div className="grid gap-4">
                    {paymentRequests.filter(p => p.status === 'pending').map((payment) => (
                      <PaymentRequestCard
                        ...
                        onReject={() => { setPaymentToReject(payment); setShowRejectionModal(true); }}
                        onViewDetails={() => { setSelectedPaymentForDetails(payment); setShowPaymentDetails(true); }}
                      />
                    ))}
                  </div>
                ) : (
                  <div className="text-center py-8 text-sm text-gray-500">All payment requests have been processed.</div>
                )}
              </div>
            )}
                                ...
                                <div className="space-y-1">
                                  ...
                                  {app.regional_manager_comment && (
                                    <div className="flex items-center gap-1 text-xs text-blue-600">
                                      ...
                                      <span className="truncate max-w-[100px]">{app.regional_manager_comment}</span>
                                    </div>
                                  )}
                                </div>
                              </td>
                  ...
                  {totalPages > 1 && (
                    <div className="flex flex-col sm:flex-row items-center justify-between px-6 py-3 border-t border-gray-300 bg-gray-50">
                      <div className="text-sm text-gray-700 mb-3 sm:mb-0">
                        ...
                        <strong>{filteredApplications.length}</strong> entries
                      </div>
            ...
            <BulkPaymentModal
              ...
              onClose={() => { setShowBulkPaymentModal(false); setJustification(''); }}
            ...
            <PaymentDetailsModal
              ...
              onApprove={() => { approvePayment(selectedPaymentForDetails); setShowPaymentDetails(false); }}
              onReject={() => { setPaymentToReject(selectedPaymentForDetails); setShowRejectionModal(true); setShowPaymentDetails(false); }}
              userRole={userRole}
            />
            <RejectionModal
              isOpen={showRejectionModal}
              onClose={() => setShowRejectionModal(false)}
              onConfirm={(reason) => { rejectPayment(paymentToReject, reason); setPaymentToReject(null); }}
            />
            <RecommendationModal
