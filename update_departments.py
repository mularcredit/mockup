        ...
        <div className="glass-card p-6 rounded-2xl">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-medium text-[var(--t2)] ml-1">Department Code</label>
              <input 
                type="text" 
                placeholder="e.g. ENG" 
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-medium text-[var(--t2)] ml-1">Department Name</label>
              <input 
                type="text" 
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-medium text-[var(--t2)] ml-1">Parent Department</label>
              <select 
...
print("Department map redesigned.")
